...
class Products with ChangeNotifier {
  List<Product> _items = [
    Product(
       ...
       price: 100,
       imageUrl:
           'https://cdn.pixabay.com/photo/2015/10/08/00/24/woman-977020__340.jpg',
     ),
    
     Product(
       id: 'p2',
       title: 'Wired Headphone',
       description: 'JBL Wired Headphone',
       price: 500,
       imageUrl:
     ...
     Product(
       ...
       description: 'Full Bassed Bluetooth speaker',
       price: 500,
       imageUrl:
